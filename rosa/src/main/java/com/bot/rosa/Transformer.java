...
public class Transformer extends RelativeLayout implements Animation.AnimationListener, MessageListener<Odometry>, NodeMain {
    ...
    private float deadZoneRatio = 0.0F / 0.0;
    private float joystickRadius = 0.0F / 0.0;
    private float parentSize = 0.0F / 0.0;
    ...
    private float turnInPlaceStartTheta = 0.0F / 0.0;
    ...
    public Transformer(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initVirtualJoystick(context);
        this.topicName = "~cmd_vel";
    }

    public Transformer(Context context, AttributeSet attrs, int defStyle) {
